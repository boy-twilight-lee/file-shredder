    ...
    <a-scrollbar>
      <div class="shred-settings-list">
        <appearance-setting
          ...
          :bubble-direction="settings.bubbleDirection"
          :bubble-align="settings.bubbleAlign"
          @choose-pet-image="choosePetImage"
          @restore-default-pet-image="restoreDefaultPetImage"
          @update-pet-size="updatePetSize"
          @update-bubble-direction="updateBubbleDirection"
          @update-bubble-align="updateBubbleAlign"
        />
        <shred-level-setting
